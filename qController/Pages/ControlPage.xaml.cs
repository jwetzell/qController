...
namespace qController
{
    public partial class ControlPage : ContentPage
    {
        ...
        private void InitGUI()
        {
            ...
            {
                case Device.iOS:
                    AbsoluteLayout.SetLayoutBounds(qCell, new Rect(0, 0, 1, 0.30));
                    topBar.HeightRequest = App.Height * .09;
                    menuButton.FontSize = App.Height * .04;
                    break;
                case Device.Android:
                    AbsoluteLayout.SetLayoutBounds(qCell, new Rect(0, 0, 1, 0.35));
        ...
        void FinishUI()
        {
            ...
            {
                case Device.iOS:
                    AbsoluteLayout.SetLayoutBounds(qControlsBlock, new Rect(0, 0.40, 1, 0.25));
                    AbsoluteLayout.SetLayoutBounds(qLevelsCell, new Rect(0.9, 0.27, 0.8, 0.25));
                    AbsoluteLayout.SetLayoutBounds(showLevelsButton, new Rect(0.02, 0.21, App.HeightUnit * 8, App.HeightUnit * 8));
                    break;
                case Device.Android:
                    AbsoluteLayout.SetLayoutBounds(qControlsBlock, new Rect(0, 0.45, 1, 0.25));
                    AbsoluteLayout.SetLayoutBounds(qLevelsCell, new Rect(0.9, 0.32, 0.8, 0.25));
                    AbsoluteLayout.SetLayoutBounds(showLevelsButton, new Rect(0.02, 0.26, App.HeightUnit * 8, App.HeightUnit * 8));
                    break;
            }
            ...
            if (args.Command.Contains("/"))
            {
                ...
                if(parts.Length > 1)
                {
                    Device.BeginInvokeOnMainThread(() =>
                    {
                        ...
                        AbsoluteLayout.SetLayoutBounds(qCueListCell, new Rect(0, 0.07, 1, 0.9));
